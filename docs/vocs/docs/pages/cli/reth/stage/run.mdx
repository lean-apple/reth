...
Networking:
  -d, --disable-discovery
      ...
      --snap
          ...
          Lets peers request account, storage, bytecode and block access list data from this node. Off by default: snap is not reth's sync path, and advertising it commits this node to answering those requests.
